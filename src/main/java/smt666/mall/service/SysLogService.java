...
import smt666.mall.dao.*;
import smt666.mall.dto.SearchLogDto;
import smt666.mall.model.*;
    ...
    public void recover(int id) {
        ...
        switch (sysLog.getType()){
            ...
            case LogType.TYPE_ROLE_ACL:
                ...
                sysRoleAclService.changRoleAcls(sysLog.getTargetId(), JsonMapper.stringToObject(sysLog.getOldValue(), new TypeReference<List<Integer>>() {
                }));
                break;
